...
import { loadLogs, loadRunLogs, loadOverrides, loadSkips } from "./actions";
...
export default async function LiftPage() {
  const [initialLogs, initialRunLogs, initialOverrides, initialSkips] =
    await Promise.all([
      loadLogs(),
      loadRunLogs(),
      loadOverrides(),
  ...
  return (
    <LiftPlan
      ...
      initialRunLogs={initialRunLogs}
      initialOverrides={initialOverrides}
      initialSkips={initialSkips}
    />
  );
}
